...
public class BibEntryTechreport extends BibEntry {
    ...
    @BibField(name = "institution", required = true)
    public BibValue institution;
     ...
     */
    public BibEntryTechreport(String id) {
        super("TechReport", id);
    }
    ...
    public BibValue getInstitution() {
        return institution;
    }

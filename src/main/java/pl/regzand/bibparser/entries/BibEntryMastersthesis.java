...
public class BibEntryMastersthesis extends BibEntry {
     ...
     */
    public BibEntryMastersthesis(String id) {
        super("MastersThesis", id);
    }
